...
const ContactUs = () => {
    return (
        <>
            <section className="text-gray-600 body-font py-10 mt-20"> {/* Added margin-top to create space between navbar and contact section */}
                <div className="container px-5 mx-auto">
                    <h1 className="text-6xl font-medium title-font text-gray-900 mb-12 text-center">CONTACT US</h1>
                </div>
            </section>
            <section className="text-gray-600 body-font relative">
                <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                    ...
                    <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                        ...
                        <div className="relative mb-4">
                            <label htmlFor="organization" className="leading-7 text-sm text-gray-600">Organization</label>
                            <input
                                type="text"
                                id="organization"
                                name="organization"
